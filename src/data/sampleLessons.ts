...
In English-speaking countries, it's polite to wait to be seated and to say "please" and "thank you" when interacting with staff.`,
    ...
    assessmentQuestions: [
      ...
      { id: 'q5', question: 'What does "What do you recommend?" mean?', options: ['What is cheap?', 'What is the best dish in your opinion?', 'What is on the menu?', 'What is the dessert?'], correctAnswer: 1, explanation: '"What do you recommend?" is asking the waiter for their personal suggestion of what\'s good.', growthMindsetFeedback: { correct: 'Great — this phrase will help you everywhere!', incorrect: '"Recommend" means to suggest something good. Use it when you want advice on what to order.' } },
      { id: 'q6', question: 'Which is the correct order of a meal?', options: ['Dessert → Main → Appetizer', 'Main → Appetizer → Dessert', 'Appetizer → Main Course → Dessert', 'Bill → Main → Appetizer'], correctAnswer: 2, explanation: 'A typical meal order is: Appetizer (starter) → Main Course → Dessert.', growthMindsetFeedback: { correct: 'You know the dining flow perfectly!', incorrect: 'Think of it like a story: start small (appetizer), then the big part (main), then the sweet ending (dessert).' } },
    ],
  },
  {
    id: 'greetings-intro',
